...
$comilla_audio_opt = get_post_meta(get_the_ID(), '_comilla_embed_code', true);
?>

<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="single_post_blog">
    <?php if($comilla_audio_opt){ ?>
		<div class="embed-responsive embed-responsive-16by9 post_audio_video"><?php echo comilla_wp_kses($comilla_audio_opt);?></div>
    <?php }?>
